...
import { spaceGrotesk, inter, jetbrainsMono, russoOne } from "@/lib/fonts";
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${spaceGrotesk.variable} ${inter.variable} ${jetbrainsMono.variable} ${russoOne.variable}`}
    >
